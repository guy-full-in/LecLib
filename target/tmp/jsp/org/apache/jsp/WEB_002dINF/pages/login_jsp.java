...
public final class login_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("    <p style=\"text-align: justify; width: 500px\">\r\n");
      out.write("        LecLib - это библиотека лекций. Здесь вы можете записать любую лекцию и затем поделиться ей с другими пользователями. Доступ к лекциям предоставляется только зарегестрированным пользователям. Авторизуйтесь в форме ниже, или <a href=\"/registr\">зарегистрируйтесь</a>\r\n");
      out.write("    </p>\r\n");
      out.write("</div>\r\n");
      out.write("<div align=\"center\" id=\"login-box\">\r\n");
      out.write("\r\n");
      out.write("    ");
